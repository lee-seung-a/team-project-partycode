...
<body>
 ...
 <div id="myCarousel" style="height:500px;" class="carousel slide" data-ride="carousel">
    ...
    <div class="container text-center">
      <h3>${users.id} 님 환영합니다.</h3>
      <p><em>${users.point} POINT</em></p>
      ...
      <div class="row">
		    ...
		    <div class="search-wrap" style="text-align:center;">
		      <button type="button" class="btn btn" onclick="location.href='party_regist'">파티등록하기</button>
                        <select class="form search-select"  style="border:1px solid black; width:150px; color:#555; height:36px; " onChange="handleChange(this)">
                                                     
                           <option value="12" ${pageVO.amount eq 12 ? 'selected' : ''}>12개 보기</option>
                           
                       </select>
                    
		     <select style="color:#555; border:1px solid black; height:36px;" class="search-select" name="searchType">
      ...
      <c:if test="${vo.padmin==0}">
        <div id="colla" class="col-sm-4">
          <div id="thumbnel" class="thumbnail">
            ...
            <img class="partyisover" src="${pageContext.request.contextPath }/resources/img/soldout.png"/>
            
            </c:if>
            <p><strong style="color:black;">${vo.ptitle }</strong></p>
            <p><span style="font-size:15px; color:black;">좋아요&nbsp;<b>${vo.plike }</b><span style="color:red;">&nbsp;♥</span></span> <div class="like"><a href="/partycode/users/othersprofile?id=${vo.pid }"><img style="background-color:lightgray; border-radius:70%;" class="like" src="${pageContext.request.contextPath }/resources/img/admin_person.png" alt=""/></a></div></p>
